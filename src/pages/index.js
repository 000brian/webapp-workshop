...
export default function Home() {
    ...
    const setPizzas = resultFromUseState[1]; // calling this setter causes the page to reset for us
    ...
    return (
        <>
            ...
            <main>
                <input type="search" name="search" data-testid="search" onChange = {(event) => {setFilterText}(event.target.value)}></input>
                <Pizzas />
            </main>
        </>
    );
